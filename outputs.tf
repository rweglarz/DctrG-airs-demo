...
#     value = "http://${google_compute_instance.ai-vm-unprotected.network_interface[0].access_config[0].nat_ip}:80}" 
# }
output "bank_app_unprotected" {
...
output "bank_app_protected" {
  value = "http://${google_compute_instance.ai-vm-protected.network_interface[0].access_config[0].nat_ip}:8888"
}
